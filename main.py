...
ax.annotate(cases_max, [ax.get_xticks()[0], cases_max], va='bottom', ha='right', color='red')
ax.annotate(deaths_max, [ax.get_xticks()[0], deaths_max], va='bottom', ha='left', color='red')
xt = ax.get_xticks()
